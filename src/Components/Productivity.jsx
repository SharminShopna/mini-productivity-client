...
const Productivity = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-5xl text-center text-teal-800 italic font-bold mb-12">Positive Habits for a Better You</h1>
        ...
        {tasks.map((task) => (
          ...
          >
            <div className="text-5xl text-center mb-4">{task.icon}
              <h2 className="text-xl  text-orange-400 font-semibold">{task.name}</h2>
